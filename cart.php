...
<section class="products">
   ...
   <div class="box-container">
      ...
      <form action="" method="post" class="box">
         ...
         <div class="flex">
            <div class="price"><span></span><?= $fetch_cart['price']; ?>đ</div>
            <input type="number" name="qty" class="qty" min="1" max="99" value="<?= $fetch_cart['quantity']; ?>" maxlength="2">
            <button type="submit" class="fas fa-edit" name="update_qty"></button>
         </div>
         <div class="sub-total"> Tổng tiền : <span><?= $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); ?>tr(vnđ)</span> </div>
      </form>
      <?php
   ...
   <div class="cart-total">
      <p>Tổng tiền giỏ hàng : <span><?= $grand_total; ?>tr(vnđ)</span></p>
      <a href="checkout.php" class="btn <?= ($grand_total > 1)?'':'disabled'; ?>">Tiến tới thanh toán</a>
   </div>
