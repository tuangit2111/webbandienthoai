               ...
               <div class="row">
                  ...
                  <div class="des">
                     ...
                     <div class="flex">
                        ...
                        <input type="number" name="qty" class="qty" min="1" max="99" value="1" maxlength="2"><hr>
                     </div>
                     <div class="color"><span>Màu sắc : </span><?= $fetch_products['color']; ?> </div><hr>
                        <div class="memory"><span>Bộ nhớ : </span><?= $fetch_products['memory']; ?> </div><hr>
