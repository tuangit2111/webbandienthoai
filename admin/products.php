...
<section class="show-products" style="padding-top: 0;">
   ...
   <h1 class="heading" style="margin-top: 20px;">Tất cả sản phẩm</h1>
   <a href="add_product.php" class="option-btn" style="margin: 20px 0 20px 70px; width: 200px">Thêm sản phẩm</a>
